...
- A like system.
- A sort view system.
- Page tabs for different generations so you can see the entire Pokédex.
- An interactive catch system and a visual update to show what Pokémon you have caught.
